...
Tanto a classe Timer bem como a StateTable foram implementadas tendo em mente o controlo de acesso concorrentes nomeadamente com recurso a lock's de modo a impedir que Threads/Processos diferentes tenham acesso simultâneo aos dados, evitando assim race conditions como dead lock's e inconsistências nos dados.
